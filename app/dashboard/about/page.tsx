			...
			<Stack gap="lg">
				...
				>
					...
					<Box style={{ position: "relative", zIndex: 1 }}>
						<Group gap="md" mb="md">
							<Avatar size="lg" radius="xl" color="white" variant="white">
						...
						<Text c="white" size="md" maw={600}>
							Aplikasi keuangan pribadi berbasis web yang membantu Anda
							mengelola keuangan sehari-hari secara menyeluruh — mulai dari
							pencatatan transaksi, pengelolaan akun, anggaran bulanan, hingga
							pelacakan utang/piutang dan transaksi berulang.
						</Text>
						<Group mt="md" gap="xs">
				...
				<div>
					...
					<Text c="dimmed" mb="lg">
						...
						— artinya bahkan pemilik/admin server tidak dapat membaca data
						keuangan pengguna. Semua data sensitif terenkripsi di database.
					</Text>
					...
					<SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md" mb="lg">
						...
						<Paper p="md" radius="md" withBorder>
							...
							<Text size="sm" c="dimmed">
								Diturunkan dari password pengguna (per-user key)
							</Text>
						</Paper>
						<Paper p="md" radius="md" withBorder>
							<Group gap="sm" mb="xs">
							...
							<Text size="sm" c="dimmed">
								Web Crypto API (kompatibel Edge Runtime)
							</Text>
						</Paper>
					</SimpleGrid>
					...
					<Timeline active={4} bulletSize={28} lineWidth={2} mb="lg">
						...
						>
							<Text c="dimmed" size="xs" lh={1.5}>
								Sistem men-generate salt unik dan menurunkan encryption key dari
								password pengguna menggunakan PBKDF2. Sebuah verifier disimpan
								untuk validasi key saat login.
							</Text>
						</TimelineItem>
						<TimelineItem
						...
						>
							<Text c="dimmed" size="xs" lh={1.5}>
								Password digunakan untuk menurunkan kembali encryption key yang
								sama. Key disimpan dalam encrypted cookie (bukan di database)
								selama sesi aktif.
							</Text>
						</TimelineItem>
						<TimelineItem
						...
						>
							<Text c="dimmed" size="xs" lh={1.5}>
								Semua data sensitif (nama akun, saldo, jumlah transaksi,
								deskripsi, nama kategori, dll.) dienkripsi dengan AES-256-GCM
						...
						>
							<Text c="dimmed" size="xs" lh={1.5}>
								Data didekripsi di server menggunakan encryption key dari
								cookie, lalu dikirim ke browser dalam bentuk plaintext.
							</Text>
						</TimelineItem>
						<TimelineItem
					...
					>
						...
						<List size="xs" spacing={4}>
							<ListItem>
								<Text size="xs">
									<Text span fw={600}>
										Lupa password = kehilangan data.
									</Text>{" "}
									Karena kunci enkripsi diturunkan dari password, tidak ada cara
									untuk memulihkan data jika password hilang.
								</Text>
							</ListItem>
							<ListItem>
								<Text size="xs">
									Data yang tersimpan di database berupa ciphertext yang tidak
									bisa dibaca tanpa kunci yang benar.
								</Text>
							</ListItem>
							<ListItem>
								<Text size="xs">
									Setiap pengguna memiliki kunci enkripsi berbeda, sehingga
									kompromi satu akun tidak mempengaruhi akun lain.
								</Text>
							</ListItem>
						</List>
					</Paper>
					...
					{/* DB Proof Screenshot */}
					<Text fw={600} mb="sm" mt="lg">
						Bukti Enkripsi Database
					</Text>
					<Text size="sm" c="dimmed" mb="md">
						Berikut tampilan data di database — semua kolom sensitif berupa
						ciphertext yang tidak terbaca tanpa kunci enkripsi pengguna.
					</Text>
				...
				<Text ta="center" size="xs" c="dimmed" pb="md">
					Cymblot Keuangan &copy; {new Date().getFullYear()} &middot; MIT
					License
				</Text>
			</Stack>
		</>
