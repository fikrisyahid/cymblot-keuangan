...
export function TransactionsClient({
	...
	const unifiedItems: UnifiedItem[] = useMemo(() => {
		...
		const isTxFilter =
			currentFilters.type === "INCOME" || currentFilters.type === "EXPENSE";

		const txItems: UnifiedItem[] =
			isTxFilter || !isTransferFilter
				? transactions.map((t) => ({ kind: "transaction" as const, data: t }))
				: [];
		const trItems: UnifiedItem[] =
			isTransferFilter || !isTxFilter
